...
/// @DnDVersion : 1
/// @DnDHash : 486F1B21
/// @DnDArgument : "code" "/// forces$(13_10)$(13_10)// inputHandler.xInput;$(13_10)// inputHandler.accelInput;$(13_10)// inputHandler.leanInput;$(13_10)$(13_10)var frontTireX = x + dcos(phy_rotation) * 10;$(13_10)var frontTireY = y + dsin(phy_rotation) * 10;$(13_10)$(13_10)var rearTireX = x - dcos(phy_rotation) * 10;$(13_10)var rearTireY = y - dsin(phy_rotation) * 10;$(13_10)$(13_10)// acceleration / braking$(13_10)if (inputHandler.accelInput > 0) {$(13_10)	var accelForce = inputHandler.accelInput * myBikeStats.maxAccel;$(13_10)	physics_apply_force(rearTireX, rearTireY, dcos(phy_rotation) * accelForce, dsin(phy_rotation) * accelForce);$(13_10)}$(13_10)else if (inputHandler.accelInput < 0) {$(13_10)	// use myBikeStats.maxReverseVelocity$(13_10)	var brakeForce = -inputHandler.accelInput * myBikeStats.maxBrake * sqrt(phy_speed * room_speed / myBikeStats.maxLinearVelocity);$(13_10)	physics_apply_force(frontTireX, frontTireY, -dcos(phy_rotation) * brakeForce, -dsin(phy_rotation) * brakeForce);$(13_10)	physics_apply_force(rearTireX, rearTireY, -dcos(phy_rotation) * brakeForce, -dsin(phy_rotation) * brakeForce);$(13_10)}$(13_10)$(13_10)// turn forces$(13_10)var turnForce = inputHandler.turnInput * myBikeStats.maxTurn;$(13_10)physics_apply_force(frontTireX, frontTireY, dcos(phy_rotation + 90) * turnForce, dsin(phy_rotation + 90) * turnForce);$(13_10)$(13_10)// lean forces$(13_10)var leanForce = inputHandler.leanInput * myBikeStats.maxLean * phy_speed * room_speed / myBikeStats.maxLinearVelocity;$(13_10)physics_apply_force(frontTireX, frontTireY, dcos(phy_rotation + 90) * leanForce, dsin(phy_rotation + 90) * leanForce);$(13_10)physics_apply_force(rearTireX, rearTireY, dcos(phy_rotation + 90) * leanForce, dsin(phy_rotation + 90) * leanForce);$(13_10)$(13_10)// ------------------------$(13_10)// friction forces$(13_10)$(13_10)var surfaceMultiplier = 1;$(13_10)if (getSurfaceAtPoint(phy_position_x, phy_position_y) == 0) {$(13_10)	surfaceMultiplier = myBikeStats.sandFrictionMultiplier;$(13_10)}$(13_10)$(13_10)//  in direction of tire, at maxLinearVelocity, frictionForce = -maxAccel$(13_10)var divisor = power(myBikeStats.maxLinearVelocity, 3) / myBikeStats.maxAccel;$(13_10)var frontTireAngle = phy_rotation;$(13_10)var frictionX = -0.5 * power(phy_linear_velocity_x, 3) / divisor;$(13_10)var frictionY = -0.5 * power(phy_linear_velocity_y, 3) / divisor;$(13_10)$(13_10)physics_apply_force(frontTireX, frontTireY, frictionX * surfaceMultiplier, frictionY * surfaceMultiplier);$(13_10)$(13_10)//  perpendicular to tires$(13_10)//physics_apply_force(frontTireX, frontTireY, -dcos(phy_rotation) * turnFrictionForce, -dsin(phy_rotation) * turnFrictionForce);$(13_10)$(13_10)$(13_10)// parallel to tire... linear velocity projected onto tire angle... always parellel so just use linear velocity$(13_10)var rearTireAngle = phy_rotation;$(13_10)frictionX = -0.5 * power(phy_linear_velocity_x, 3) / divisor;$(13_10)frictionY = -0.5 * power(phy_linear_velocity_y, 3) / divisor;$(13_10)physics_apply_force(rearTireX, rearTireY, frictionX * surfaceMultiplier, frictionY * surfaceMultiplier);$(13_10)$(13_10)// perpendicular to tire... linear velocity projected onto perpendicular tire angle$(13_10)var projection = dot_product(phy_linear_velocity_x / myBikeStats.maxLinearVelocity, phy_linear_velocity_y / myBikeStats.maxLinearVelocity,$(13_10)	dcos(phy_rotation + 90), dsin(phy_rotation + 90));$(13_10)var rearPerpendicularMagnitude = projection * myBikeStats.maxPerpendicularFriction;$(13_10)frictionX = -rearPerpendicularMagnitude * phy_linear_velocity_x / myBikeStats.maxLinearVelocity;$(13_10)frictionY = -rearPerpendicularMagnitude * phy_linear_velocity_y / myBikeStats.maxLinearVelocity;$(13_10)physics_apply_force(rearTireX, rearTireY, frictionX * surfaceMultiplier, frictionY * surfaceMultiplier);$(13_10)"
/// forces
...
if (inputHandler.accelInput > 0) {
	...
	var brakeForce = -inputHandler.accelInput * myBikeStats.maxBrake * sqrt(phy_speed * room_speed / myBikeStats.maxLinearVelocity);
...
// turn forces
var turnForce = inputHandler.turnInput * myBikeStats.maxTurn;
...
var surfaceMultiplier = 1;
if (getSurfaceAtPoint(phy_position_x, phy_position_y) == 0) {
	surfaceMultiplier = myBikeStats.sandFrictionMultiplier;
}
...
physics_apply_force(frontTireX, frontTireY, frictionX * surfaceMultiplier, frictionY * surfaceMultiplier);
...
physics_apply_force(rearTireX, rearTireY, frictionX * surfaceMultiplier, frictionY * surfaceMultiplier);

// perpendicular to tire... linear velocity projected onto perpendicular tire angle
var projection = dot_product(phy_linear_velocity_x / myBikeStats.maxLinearVelocity, phy_linear_velocity_y / myBikeStats.maxLinearVelocity,
	dcos(phy_rotation + 90), dsin(phy_rotation + 90));
var rearPerpendicularMagnitude = projection * myBikeStats.maxPerpendicularFriction;
